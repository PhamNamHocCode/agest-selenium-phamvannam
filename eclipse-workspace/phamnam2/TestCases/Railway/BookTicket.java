...
public class BookTicket extends TestBase{
	...
	public void TC15() {
	    ...
	    Assert.assertEquals(bookTicketPage.getSelectedDepartStation(), departStation.getDisplayText(), msgDepart);
	    Assert.assertEquals(bookTicketPage.getSelectedArriveStation(), arriveStation.getDisplayText(), msgArrive);
